...
const CRISIS_RESOURCES = [
  {
    ...
    description:
      "Emergency Indian Sign Language support via WhatsApp Video call.",
    contact: "8929667579",
    type: "video",
  ...
  },
  {
    ...
    description:
      "Professional mental health counseling via email and chat for DHH.",
  ...
  },
  {
    ...
    description:
      "Text-based support for emotional distress and suicidal thoughts.",
    contact: "TEXT 741741",
    type: "chat",
      ...
      >
        ...
        <div className="p-6 border-b border-border bg-rose-500/5">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3 text-rose-400">
              ...
              <h2 className="text-xl font-display font-bold">Crisis Support</h2>
            </div>
            <button
              onClick={onClose}
          ...
          <p className="text-sm text-muted-foreground">
            If you are in immediate danger or need urgent help, these resources
            offer text and sign-language friendly support in India.
          </p>
        </div>
        ...
        <div className="p-6 bg-secondary/30 text-center">
          <p className="text-xs text-muted-foreground">
            You matter. Reach out to someone you trust, or use one of these
            professional services right now.
          </p>
          <button
            onClick={onClose}
